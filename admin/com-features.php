...
$pageNav=""; $heading = "Community Features" ; $tbname = "community_features" ; $ORDER="com_feature" ;
...
if ( ($_POST['ACTION']=='ADD') ):
	$q = mysql_query("insert into $tbname (rid,com_feature) VALUES (0, '$d_answer') ") or die ( mysql_error() ) ;
endif;
...
if ( ($_POST['ACTION']=='EDIT')):
	$q = mysql_query("UPDATE $tbname set com_feature='$d_answer' where rid='$_REQUEST[ID]'") or die ( mysql_error() ) ;
endif;
        ...
        <tr>
		 ...
		 <table border="1" cellspacing="0" cellpadding="5" style="border-collapse: collapse" bordercolor="#cccccc" width="100%" id="AutoNumber1">
		  <tr>
		    ...
		    <td width="60%" class="tbhead" align="center"><b>Features</b></td>
...
<form method="POST" action="<?= $PHP_SELF ?>" onSubmit="return validateForm(this,0,0,0,0);" onFocusOut="clearStyle(event.srcElement);">
	...
	<table border="0" width="80%" id="table1" align="center" cellpadding="4">
		<tr <?= rowcol(1) ?>>
			<td width="10%">Community Feature</td>
			<td valign="top">
				<input type="text" class="find" name="answer" style='width:100%' value="<?= $d["com_feature"] ?>" alt=length|2 >
			</td>
		</tr>
