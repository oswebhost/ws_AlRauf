...
$pageNav=""; $heading = "Property Features" ; $tbname = "property_features" ; $ORDER="pro_feature" ;
...
if ( ($_POST['ACTION']=='ADD') ):
	$q = mysql_query("insert into $tbname (rid,pro_feature) VALUES (0, '$d_answer') ") or die ( mysql_error() ) ;
endif;
...
if ( ($_POST['ACTION']=='EDIT')):
	$q = mysql_query("UPDATE $tbname set pro_feature='$d_answer' where rid='$_REQUEST[ID]'") or die ( mysql_error() ) ;
endif;
...
<form method="POST" action="<?= $PHP_SELF ?>" onSubmit="return validateForm(this,0,0,0,0);" onFocusOut="clearStyle(event.srcElement);">
	...
	<table border="0" width="80%" id="table1" align="center" cellpadding="4">
		<tr <?= rowcol(1) ?>>
			<td width="10%">Property Feature</td>
			<td valign="top">
				<input type="text" class="find" name="answer" style='width:100%' value="<?= $d["pro_feature"] ?>" alt=length|2 >
			</td>
		</tr>
