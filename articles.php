...
$per_page=10;
$q = mysql_query("select * from news where news='0' order by rid desc ") or die(mysql_error());
...
$q = mysql_query("SELECT * from news  where news='0' order by rank, rid desc LIMIT $PAGE,$per_page") or die (mysql_error());
...
$PAGE_TITILE = "$cap Articles " . $PAGE_TITILE ;
...
$p = $_GET["PAGE"];
echo  "<h3 style='margin-bottom:10px;'>Articles</h3>";
